...
num_modes = 0
with open(fichier_1, 'r') as filin_1, open(fichier_2, "r") as filin_2, open("Bilan_dockings_holo.txt", "a") as sortie_1, open("Poses_holo.txt", "a") as sortie_2, open("Energies_holo.txt", "a") as sortie_3, open("RMSD_holo.txt", "a") as sortie_4:
	for line in filin_1:
