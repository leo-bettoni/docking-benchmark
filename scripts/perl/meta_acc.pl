...
# ./meta_acc.pl INPUT 1 30 1000 2> err
...
foreach my $line (@file){
    chomp $line;
    my @A = `python3 compute_stats.py $line $ARGV[1] apo $ARGV[2] $ARGV[3]`;
    print "python3 compute_stats.py $line $ARGV[1] apo $ARGV[2] $ARGV[3] -> ";
    print "$A[0]";
    my @B = `python3 compute_stats.py $line $ARGV[1] holo $ARGV[2] $ARGV[3]`;
    print "python3 compute_stats.py $line $ARGV[1] holo $ARGV[2] $ARGV[3] -> ";
    print "$B[0]";
